    ...
    >
      ...
      <div
        style={{
          ...
          borderRadius: "50%",
          background:
            "radial-gradient(circle, rgba(199,141,107,0.25) 0%, transparent 70%)",
        }}
      />
      <div
        style={{
          ...
          borderRadius: "50%",
          background:
            "radial-gradient(circle, rgba(196,112,78,0.2) 0%, transparent 70%)",
        }}
      />
      {/* Top accent line */}
      <div
        style={{
          ...
          height: "6px",
          background:
            "linear-gradient(90deg, #C4704E 0%, #D4A76A 50%, #C78D6B 100%)",
        }}
      />
