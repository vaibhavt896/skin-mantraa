...
const CREDENTIALS = [
  ...
  {
    label: "Institution",
    value: "Institute of Medical Sciences, BHU (IMS BHU)",
  },
  { label: "Experience", value: "26+ years clinical practice" },
  { label: "Specialisation", value: "Dermatology & Cosmetology" },
  {
    label: "Previous Role",
    value: "Consultant Dermatologist, Kaya Skin Clinic, New Delhi",
  },
  {
    label: "Current Role",
    value: "Director & Consultant, SKIN@Mantraa, Kanpur",
  },
];
...
const MEMBERSHIPS = [
  ...
  {
    short: "IADVL",
    full: "Indian Association of Dermatologists, Venereologists and Leprologists",
  },
      ...
      <main style={{ background: "#FDF6EC" }}>
        ...
        >
          <div className="max-w-4xl mx-auto">
            ...
            >
              Kanpur&apos;s most experienced female dermatologist and
              cosmetologist. Rated #1 by ThreeBestRated.in. 451+ verified
              patient reviews. Director of SKIN@Mantraa, Swaroop Nagar -
              Kanpur&apos;s premier clinical dermatology practice.
            </p>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            >
              ...
              >
                ...
                gaining advanced exposure to clinical and cosmetic dermatology
                in a high-volume practice before returning to Kanpur to
                establish SKIN@Mantraa.
              </p>
              <p
                style={{
                  fontFamily: "var(--font-body)",
          ...
          <div className="max-w-4xl mx-auto">
            ...
            >
              {[
                ...
                {
                  heading: "Acne & Skin Conditions",
                  items: [
                    "Acne Treatment (All Grades)",
                    "Acne Scar Removal",
                    "Dermapen 4 Microneedling",
                    "Chemical Peels",
                    "Melasma, Vitiligo, Psoriasis, Eczema",
                  ],
                },
                {
        ...
        >
          <div className="max-w-2xl mx-auto">
            ...
            >
              SKIN@Mantraa, Swaroop Nagar, Kanpur · ₹600 consultation fee ·
              Monday–Saturday
            </p>
            <div
              style={{
