...
const SERVICES_LIST = [
  {
    ...
    desc: "Hair removal, pigmentation, tattoo removal, Nd:YAG, diode laser",
  },
  {
    id: "anti-aging",
    label: "Anti-Aging & Cosmetics",
    desc: "Botox, dermal fillers, thread lift, HIFU skin tightening",
  },
  {
    id: "acne-scars",
    label: "Acne & Scar Treatment",
    desc: "Dermapen 4, chemical peels, TCA cross, acne management",
  },
  {
    id: "hair-restoration",
    label: "Hair Restoration",
    desc: "PRP therapy, GFC treatment, mesotherapy, hair loss diagnosis",
  },
  {
    id: "skin-conditions",
    label: "Skin Disease Treatment",
    desc: "Vitiligo, psoriasis, eczema, melasma, fungal infections",
  },
  {
    id: "cosmetic",
    label: "Cosmetic Dermatology",
    desc: "Carbon laser facial, hydrafacial, skin resurfacing, pigmentation",
  },
];
      ...
      <main style={{ background: "#FDF6EC" }}>
        ...
        <section style={{ background: "#FFFFFF", padding: "5rem 1.5rem" }}>
          <div className="max-w-4xl mx-auto">
            ...
            >
              ...
              >
                She is a member of the Indian Medical Association (IMA), the
                Indian Association of Dermatologists, Venereologists and
                Leprologists (IADVL), and the Cosmetology Society of India
                (CDSI). She previously served as Consultant at Kaya Skin Clinic,
                New Delhi, before establishing SKIN@Mantraa in Kanpur.
              </p>
              <p
                style={{
                  fontFamily: "var(--font-body)",
              ...
              >
                ...
                treatment, and combination anti-aging approaches.
              </p>
            </div>
            <div
              style={{
        ...
        <section style={{ background: "#FFFFFF", padding: "5rem 1.5rem" }}>
          ...
          >
            <div>
              ...
              >
                Bungalow No. 4, 113/196
                <br />
                Swaroop Nagar
                <br />
                Behind Hotel Royal Cliff
                <br />
              ...
              >
                Easily accessible from Kakadeo, Civil Lines, Kidwai Nagar,
                Govind Nagar, and Rawatpur.
              </p>
              <div
                style={{
                  marginTop: "1.25rem",
              ...
              >
                ...
                >
                  💬 WhatsApp: {BRAND.clinic.whatsappDisplay}
                </a>
              </div>
            </div>
            <div>
        ...
        <section style={{ background: "#FFFFFF", padding: "5rem 1.5rem" }}>
          <div className="max-w-4xl mx-auto">
            ...
            >
              Patient details anonymised. Results are individual and vary based
              on condition, compliance, and treatment plan.
            </p>
          </div>
        </section>
        ...
        >
          <div className="max-w-2xl mx-auto">
            ...
            >
              Consultation with Dr. Mamta Bhura: ₹600. Monday–Saturday. Walk-ins
              welcome.
            </p>
            <div
              style={{
