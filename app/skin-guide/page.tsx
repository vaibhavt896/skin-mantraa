  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background: "linear-gradient(90deg, #C4704E 0%, #D4A76A 100%)",
        }}
      />
    ...
    <>
      ...
      <main>
        ...
        <section
          ...
          style={{
            background:
              "linear-gradient(160deg, #FDF6EC 0%, #F5E6D3 70%, #FDF6EC 100%)",
          }}
        >
          {/* Decorative elements */}
          <div
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-8 relative">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                >
                  Expert skin care wisdom from Dr. Mamta Bhura -
                  <br className="hidden md:block" /> evidence-based, practical,
                  honest.
                </p>
              </motion.div>
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            ...
            >
              ...
              <Link
                ...
                onMouseEnter={(e) => {
                  (e.currentTarget as HTMLElement).style.boxShadow =
                    "0 16px 60px rgba(61,43,31,0.14)";
              ...
              >
                ...
                <div
                  ...
                  style={{
                    background:
                      "linear-gradient(135deg, #F5E6D3 0%, #F8E8E0 30%, #FDF6EC 55%, #F5E6D3 80%, #C78D6B22 100%)",
                  }}
                >
                  ...
                  <div className="relative z-10 flex flex-col items-center gap-3">
                    ...
                    >
                      ...
                      >
                        ...
                        {/* sun rays */}
                        <path
                          d="M18 4v3M18 29v3M4 18h3M29 18h3M7.76 7.76l2.12 2.12M26.12 26.12l2.12 2.12M7.76 28.24l2.12-2.12M26.12 9.88l2.12-2.12"
                          stroke="#C78D6B"
                          strokeWidth="1.2"
                          strokeLinecap="round"
                          opacity="0.5"
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    >
                      ...
                      >
                        ...
                        />
                        <path
                          d="M2 14c0-2.5 2.7-4.5 6-4.5s6 2 6 4.5"
                          stroke="white"
                          strokeWidth="1.3"
                          strokeLinecap="round"
                        />
            ...
            <div className="flex gap-2 overflow-x-auto pb-1">
              <button
                ...
                style={{
                  fontFamily: "var(--font-accent)",
                  background:
                    activeCategory === "All" ? "#C4704E" : "transparent",
              ...
              {ARTICLE_CATEGORIES.map((cat) => (
                <button
                  ...
                  style={{
                    fontFamily: "var(--font-accent)",
                    background:
                      activeCategory === cat ? "#C4704E" : "transparent",
              ...
              >
                ...
                {subscribed ? (
                  ...
                  >
                    ...
                    >
                      You&apos;ll receive Dr. Bhura&apos;s next skin guide in
                      your inbox.
                    </p>
                  </motion.div>
                ) : (
                    ...
                    <button
                      ...
                      onMouseEnter={(e) => {
                        (e.currentTarget as HTMLElement).style.transform =
                          "translateY(-2px)";
                        (e.currentTarget as HTMLElement).style.boxShadow =
                          "0 8px 24px rgba(196,112,78,0.4)";
                      }}
                      onMouseLeave={(e) => {
                        (e.currentTarget as HTMLElement).style.transform =
                          "translateY(0)";
                        (e.currentTarget as HTMLElement).style.boxShadow =
                          "0 4px 16px rgba(196,112,78,0.3)";
                      }}
                    >
                      Subscribe
                    </button>
