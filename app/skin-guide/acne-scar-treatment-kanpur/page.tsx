...
export const metadata: Metadata = {
  title: "Acne Treatment and Scar Removal in Kanpur — Dermapen 4, Chemical Peels | SKIN@Mantraa",
  description:
  ...
  openGraph: {
    title: "Acne Treatment and Scar Removal in Kanpur — Dermapen 4, Chemical Peels",
    description:
...
const blogSchema = {
  ...
  mainEntityOfPage: "https://skinmantraa.in/skin-guide/acne-scar-treatment-kanpur",
  keywords:
        ...
        <article className="pt-40 pb-24">
          <header className="max-w-4xl mx-auto px-6 lg:px-8 mb-14">
            ...
            <h1 style={styles.heading1}>
              Acne Treatment and Scar Removal in Kanpur<br />
              <span style={{ color: "#C4704E" }}>Dermapen 4, Chemical Peels, and What Actually Works</span>
            </h1>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "0.75rem", paddingTop: "1rem", borderTop: "1px solid rgba(199,141,107,0.25)" }}>
              <div>
                ...
                <p style={{ fontFamily: "var(--font-body)", fontSize: "0.82rem", color: "#8C6F5E", margin: 0 }}>MD Dermatology, IMS BHU · 26+ years · Best dermatologist in Kanpur for acne and scar treatment</p>
              </div>
            </div>
          </header>
          ...
          <div className="max-w-3xl mx-auto px-6 lg:px-8">
            ...
            <h2 style={styles.heading2}>Three Different Problems, Three Different Treatments</h2>
            <p style={styles.para}>
              When patients say &quot;I have acne scars,&quot; they typically mean one of three distinct things:
            </p>
            <ul style={styles.ul}>
              <li style={styles.li}><strong>Active acne</strong> — the condition itself: comedones, papules, pustules, cysts. Needs to be controlled medically before any scar treatment begins.</li>
              <li style={styles.li}><strong>Post-inflammatory hyperpigmentation (PIH)</strong> — the dark marks left after a pimple heals. Flat, discoloured skin. Not a true scar. Treatable with topicals + peels.</li>
              <li style={styles.li}><strong>Atrophic scars</strong> — actual structural damage: ice-pick (deep, narrow), boxcar (broad, sharp edges), rolling (broad, sloped). These require procedural treatment: Dermapen, subcision, TCA cross, or laser resurfacing.</li>
            </ul>
            <p style={styles.para}>
            ...
            <h2 style={styles.heading2}>Treating Active Acne — Medical Control First</h2>
            <p style={styles.para}>
            ...
            <ul style={styles.ul}>
              <li style={styles.li}><strong>Mild comedonal acne</strong>: Topical retinoids (tretinoin or adapalene) + benzoyl peroxide</li>
              <li style={styles.li}><strong>Moderate papulopustular acne</strong>: Topical clindamycin combination + oral doxycycline (short course)</li>
              <li style={styles.li}><strong>Severe nodular/cystic acne</strong>: Oral isotretinoin (Accutane) — the most effective treatment for severe, scarring acne</li>
            </ul>
            <p style={styles.para}>
            ...
            <h2 style={styles.heading2}>Chemical Peels for Post-Acne Dark Spots</h2>
            <p style={styles.para}>
            ...
            <ul style={styles.ul}>
              <li style={styles.li}><strong>Priming phase</strong> (4 weeks): Topical depigmenting agents — modified Kligman&apos;s formula, tranexamic acid, or kojic acid combination — to suppress melanocyte activity before peeling</li>
              <li style={styles.li}><strong>Peeling phase</strong>: Glycolic acid (30–50%) or mandelic acid peels, 4 to 6 sessions spaced 3 to 4 weeks apart</li>
              <li style={styles.li}><strong>Maintenance</strong>: SPF 50+ PA+++ sunscreen daily (mandatory — UV exposure will darken marks again)</li>
            </ul>
            <p style={styles.para}>
            ...
            <ul style={styles.ul}>
              <li style={styles.li}>Sessions: 4 to 6 total, spaced 4 weeks apart</li>
              <li style={styles.li}>Needle depth: adjusted per area (0.5mm for surface PIH, up to 2.5mm for deep atrophic scars)</li>
              <li style={styles.li}>Topical serums (hyaluronic acid, growth factors) applied during treatment to enhance collagen response</li>
              <li style={styles.li}>Downtime: 24 to 48 hours of redness; return to normal activities the following day</li>
              <li style={styles.li}>Results: visible improvement by session 3; full collagen remodelling visible at 3 to 6 months post-course</li>
            </ul>
            <p style={styles.para}>
            ...
            <ul style={styles.ul}>
              <li style={styles.li}><strong>Active acne</strong>: 1064nm long-pulse Nd:YAG targets the sebaceous glands and reduces P. acnes activity, with anti-inflammatory effects that reduce papule and pustule formation</li>
              <li style={styles.li}><strong>Post-acne pigmentation and skin texture</strong>: Q-switched Nd:YAG (toning protocol) targets melanin in dark spots and improves overall skin clarity</li>
            </ul>
            <p style={styles.para}>
            ...
            <div style={{ background: "#3D2B1F", borderRadius: "12px", padding: "2.5rem", marginTop: "3rem", textAlign: "center" }}>
              ...
              <div style={{ display: "flex", gap: "1rem", justifyContent: "center", flexWrap: "wrap" }}>
                <Link href="/contact" style={{ display: "inline-block", padding: "0.8rem 2rem", background: "#C4704E", color: "#ffffff", borderRadius: "6px", fontFamily: "var(--font-accent)", fontSize: "0.9rem", fontWeight: 600, letterSpacing: "0.05em", textDecoration: "none" }}>
                  Book Consultation
                </Link>
                <Link href="/services/skin-treatments" style={{ display: "inline-block", padding: "0.8rem 2rem", background: "transparent", color: "#C78D6B", border: "1px solid rgba(199,141,107,0.4)", borderRadius: "6px", fontFamily: "var(--font-accent)", fontSize: "0.9rem", fontWeight: 600, letterSpacing: "0.05em", textDecoration: "none" }}>
                  Skin Treatments
                </Link>
              </div>
            </div>
            ...
            <div style={{ marginTop: "3rem", paddingTop: "2rem", borderTop: "1px solid rgba(199,141,107,0.2)" }}>
              ...
              <div style={{ display: "flex", flexWrap: "wrap", gap: "0.5rem" }}>
                {["acne treatment Kanpur", "acne scar removal Kanpur", "Dermapen 4 Kanpur", "chemical peel Kanpur", "dark spots Kanpur", "skin resurfacing Kanpur"].map((tag) => (
                  <span key={tag} style={{ padding: "0.2rem 0.75rem", background: "rgba(199,141,107,0.1)", color: "#7a3b1e", fontSize: "0.72rem", fontFamily: "var(--font-accent)", borderRadius: "999px" }}>{tag}</span>
                ))}
              </div>
              <div style={{ marginTop: "1.5rem" }}>
                <Link href="/skin-guide" style={{ fontFamily: "var(--font-body)", fontSize: "0.9rem", color: "#C4704E", textDecoration: "none" }}>← Back to Skin Guide</Link>
              </div>
            </div>
          </div>
        </article>
