...
export const metadata: Metadata = {
  title: "Botox vs Dermal Fillers — What Is the Difference? | SKIN@Mantraa Kanpur",
  description:
  ...
  alternates: {
    canonical: "https://skinmantraa.in/skin-guide/botox-vs-dermal-fillers-kanpur",
  },
  openGraph: {
...
const blogSchema = {
  ...
  mainEntityOfPage: "https://skinmantraa.in/skin-guide/botox-vs-dermal-fillers-kanpur",
  keywords:
        ...
        <article className="pt-40 pb-24">
          ...
          <header className="max-w-4xl mx-auto px-6 lg:px-8 mb-14">
            ...
            <h1 style={styles.heading1}>
              Botox vs Dermal Fillers<br />
              <span style={{ color: "#C4704E" }}>What Is the Difference and Who Needs Which?</span>
            </h1>
          ...
          <div className="max-w-3xl mx-auto px-6 lg:px-8">
            ...
            <h2 style={styles.heading2}>What Dermal Fillers Are and What They Do</h2>
            <p style={styles.para}>
            ...
            <ul style={styles.ul}>
              <li style={styles.li}><strong>Cheeks</strong> — restoring midface volume and lifting the lower face passively</li>
              <li style={styles.li}><strong>Nasolabial folds</strong> — softening deep nose-to-mouth lines</li>
              <li style={styles.li}><strong>Under-eye (tear trough)</strong> — addressing hollowing and dark circles caused by volume loss</li>
              <li style={styles.li}><strong>Lips</strong> — enhancing definition, volume, or symmetry</li>
              <li style={styles.li}><strong>Jawline and chin</strong> — improving facial structure and definition</li>
            </ul>
            <p style={styles.para}>
              Fillers address <em>static</em> lines and volume deficits — changes present even when the face is completely at rest, unrelated to muscle movement.
            </p>

            <h2 style={styles.heading2}>The Key Distinction: Dynamic vs Static Ageing</h2>
            <p style={styles.para}>
            ...
            <ul style={styles.ul}>
              <li style={styles.li}><strong>Dynamic</strong> (lines appear or worsen when you move your face): Botox is the primary tool</li>
              <li style={styles.li}><strong>Static</strong> (loss of fullness, hollowing, deep creases at rest): Fillers are the primary tool</li>
              <li style={styles.li}><strong>Both</strong>: A combination approach is appropriate</li>
            </ul>
            <p style={styles.para}>
            ...
            <ul style={styles.ul}>
              <li style={styles.li}>Botox for the upper face (forehead, glabellar, crow&apos;s feet)</li>
              <li style={styles.li}>Fillers for the mid-face (cheeks, tear trough) and lower face (nasolabial folds, lips, jawline)</li>
            </ul>
            <p style={styles.para}>
            ...
            <div style={{ marginTop: "3rem", paddingTop: "2rem", borderTop: "1px solid rgba(199,141,107,0.2)" }}>
              ...
              <div style={{ display: "flex", flexWrap: "wrap", gap: "0.5rem" }}>
                {["botox Kanpur", "dermal fillers Kanpur", "anti-aging treatment", "botox vs fillers", "wrinkle treatment", "dermatologist Kanpur"].map((tag) => (
                  <span
                    key={tag}
                    style={{
