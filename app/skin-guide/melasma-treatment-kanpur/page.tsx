...
const blogSchema = {
  ...
  mainEntityOfPage:
    "https://skinmantraa.in/skin-guide/melasma-treatment-kanpur",
  keywords:
  ...
  about: [
    {
      ...
      name: "Melasma",
      alternateName: "Chloasma",
      description:
        "A chronic skin pigmentation disorder caused by overactivation of melanocytes, triggered by UV exposure, hormonal changes, and heat. Especially prevalent on Indian skin (Fitzpatrick III–V).",
      possibleTreatment: [
        { "@type": "MedicalTherapy", name: "Chemical Peel" },
        { "@type": "MedicalTherapy", name: "Q-Switch Laser" },
        { "@type": "MedicalTherapy", name: "Tranexamic Acid Therapy" },
      ],
    },
    {
      ...
      description:
        "Phased dermatological treatment for melasma including sun protection, topical priming, and procedure-based depigmentation.",
        ...
        <article className="pt-40 pb-24">
          ...
          <header className="max-w-4xl mx-auto px-6 lg:px-8 mb-14">
            ...
            <h1 style={styles.heading1}>
              What Causes Melasma and
              <br />
              <span style={{ color: "#C4704E" }}>
                How to Treat It on Indian Skin
              </span>
            </h1>
          ...
          <div className="max-w-3xl mx-auto px-6 lg:px-8">
            ...
            <p style={styles.para}>
              ...
              melasma responds faster to topical treatment and peels, while
              dermal melasma requires longer timelines and may need laser.
            </p>
            <p style={styles.para}>
              Under a Wood&apos;s lamp examination, epidermal melasma becomes
              more pronounced (the contrast sharpens), while dermal melasma does
            ...
            <p style={styles.para}>
              <strong>1. UV radiation</strong>
            </p>
            <p style={styles.para}>
              UVA and UVB from sunlight directly activate melanocytes via DNA
              photodamage signals and oxidative stress pathways. A single day of
              significant sun exposure without protection can undo weeks of
              depigmenting treatment. This is the primary trigger for melasma in
              almost every patient, regardless of other factors.
            </p>
            <p style={styles.para}>
              <strong>2. Hormonal changes</strong>
            </p>
            <p style={styles.para}>
              Estrogen and progesterone stimulate melanocyte-stimulating hormone
              (MSH) activity, increasing the skin&apos;s pigment response. This
              is why melasma is common during pregnancy (sometimes called the
            ...
            <p style={styles.para}>
              ...
              blocked. In Kanpur&apos;s summer climate (40–45°C), this is
              particularly relevant.
            </p>

            <h2 style={styles.heading2}>
              Why Indian Skin Is More Vulnerable to Melasma
            </h2>
            <p style={styles.para}>
            ...
            <ul style={styles.ul}>
              ...
              <li style={styles.li}>
                More prone to post-inflammatory hyperpigmentation from
                aggressive treatment
              </li>
              <li style={styles.li}>
                More likely to recur after clearance if photoprotection lapses
              </li>
            </ul>
            <p style={styles.para}>
            ...
            <h2 style={styles.heading2}>
              The Treatment Approach for Indian Skin Melasma
            </h2>
            <p style={styles.para}>
              Treating melasma in Indian skin is a structured, phased process.
              There is no single-session fix, and shortcutting the sequence
            ...
            <p style={styles.para}>
              ...
              depigmenting agents. We use combinations based on modified
              Kligman&apos;s formula (hydroquinone/tretinoin/steroid),
              tranexamic acid, azelaic acid, kojic acid, or niacinamide
              depending on the patient&apos;s skin sensitivity and melasma
              depth. Priming suppresses melanocyte activity and reduces the risk
              of post-inflammatory hyperpigmentation from subsequent procedures.
              Skipping this phase and going straight to peels or laser is a
            ...
            <p style={styles.para}>
              ...
              concentrations and progressively increased. Glycolic acid, lactic
              acid, and Jessner&apos;s solution are the most common choices for
              Indian skin melasma. For deep or recalcitrant melasma, Q-switched
              Nd:YAG laser at low fluence (the toning protocol) can be added -
              but only after priming, and with conservative settings calibrated
              for Indian skin.
            </p>
            <p style={styles.para}>
            ...
            <p style={styles.para}>
              ...
              broad-spectrum SPF 50+ PA+++ sunscreen must be used every morning
              (and reapplied if outdoors). A maintenance topical agent -
              typically a lower-strength version of what was used in Phase 1 -
              is continued 2 to 3 nights per week. Physical protection (hats,
              avoiding peak sun hours) adds another layer of prevention.
            </p>

            <h2 style={styles.heading2}>What Makes Melasma Worse</h2>
            <p style={styles.para}>
              The most common mistakes that worsen melasma or cause recurrence:
            </p>
            <ul style={styles.ul}>
              <li style={styles.li}>
              ...
              <li style={styles.li}>
                Not addressing hormonal triggers (contraceptive pill, thyroid)
            ...
            >
              ...
              >
                Dr. Bhura will assess your melasma depth, identify your
                triggers, and build a phased treatment plan calibrated for
                Indian skin. Consultation: ₹600.
              </p>
              <div
                style={{
                  display: "flex",
