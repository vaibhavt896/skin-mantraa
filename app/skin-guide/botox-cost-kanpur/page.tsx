...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: "article",
    images: [{ url: "/opengraph-image", width: 1200, height: 630, alt: "Botox Cost Kanpur" }],
  },
};
...
const blogSchema = {
  ...
  "@type": "BlogPosting",
  headline: "Botox Cost in Kanpur (2026) — An Honest Pricing Guide by a Dermatologist",
  description:
        ...
        <article className="pt-40 pb-24">
          <header className="max-w-4xl mx-auto px-6 lg:px-8 mb-14">
            ...
            <h1 style={styles.heading1}>
              ...
              <br />
              <span style={{ color: "#C4704E" }}>What You Actually Pay — and Why</span>
            </h1>

            <p style={{ ...styles.para, fontSize: "1.15rem", color: "#5C4033" }}>
              Botox pricing in Kanpur is not a flat fee — it is priced per unit of toxin used, and the
              number of units depends on the area being treated and the individual patient. Understanding
              this structure helps you compare options accurately.
            </p>
          ...
          <div className="max-w-3xl mx-auto px-6 lg:px-8">
            ...
            <p style={styles.para}>
              Botox is sold in vials and used in units. The per-unit cost varies by brand (Botox, Dysport,
              Xeomin) and clinic. What matters to you as a patient is how many units your specific treatment
              requires — which determines the total session cost.
            </p>
            <p style={styles.para}>
              This is why a flat "Botox for forehead: ₹X" quote is often misleading. Some patients with
              strong forehead muscles need more units than others. A competent dermatologist assesses your
              muscle strength and movement before deciding on units — not after.
            </p>

            <h2 style={styles.heading2}>How Many Units Does Each Area Need?</h2>
            <p style={styles.para}>
              These are typical ranges. Individual anatomy varies and Dr. Bhura assesses each patient before
              determining the precise amount:
            </p>
            <ul style={styles.ul}>
              <li style={styles.li}><strong>Forehead lines:</strong> 10–20 units</li>
              <li style={styles.li}><strong>Glabella (frown lines / "11s"):</strong> 15–25 units</li>
              <li style={styles.li}><strong>Crow's feet (both sides):</strong> 10–15 units per side</li>
              <li style={styles.li}><strong>Brow lift:</strong> 2–5 units per side</li>
              <li style={styles.li}><strong>Lip flip (upper lip):</strong> 4–6 units</li>
              <li style={styles.li}><strong>Bunny lines (nose):</strong> 5–10 units</li>
              <li style={styles.li}><strong>Jaw slimming / bruxism (masseter):</strong> 20–40 units per side</li>
              <li style={styles.li}><strong>Neck bands (platysmal bands):</strong> 25–50 units</li>
              <li style={styles.li}><strong>Hyperhidrosis (underarm sweating):</strong> 50–100 units total</li>
            </ul>
            <p style={styles.para}>
              A full upper face treatment (forehead + glabella + crow's feet) typically requires 50 to 70 units
              total. Preventive Botox for younger patients with early lines typically requires fewer units.
            </p>

            <h2 style={styles.heading2}>The Most Important Question Is Not the Price</h2>
            <p style={styles.para}>
              Botox is a prescription medicine. It should only be injected by a qualified medical doctor —
              a dermatologist or plastic surgeon — not by beauty therapists, nurses, or untrained aestheticians.
              The most common complications are not caused by the product itself; they are caused by incorrect
              placement and dosing.
            </p>
            <p style={styles.para}>
              Over-treated Botox produces the &ldquo;frozen&rdquo; look that makes patients look operated-upon
              rather than rested. Under-dosed Botox produces results that last 4 to 6 weeks before wearing off
              unevenly. Incorrectly placed Botox near the brow can cause ptosis (drooping eyelid) — a complication
              that takes 3 months to resolve on its own.
            </p>
            <p style={styles.para}>
              At SKIN@Mantraa, all injectable treatments are performed personally by Dr. Mamta Bhura. The
              approach is conservative micro-dosing: softening expression lines while preserving natural
              facial movement. The goal is that you look rested, not treated.
            </p>

            <h2 style={styles.heading2}>How Long Do Results Last?</h2>
            <p style={styles.para}>
              Botox results become visible within 7 to 14 days after the injection and last 3 to 6 months.
              With regular treatment (every 3 to 4 months), many patients find that results last progressively
              longer as treated muscles become less hyperactive over time. Some patients who have been treating
              consistently for 2 or more years only need 2 sessions per year.
            </p>
            ...
            >
              ...
              <p style={{ fontFamily: "var(--font-body)", fontSize: "0.97rem", color: "rgba(253,246,236,0.75)", marginBottom: "1.75rem", lineHeight: 1.7 }}>
                Dr. Bhura will assess your facial anatomy, discuss your goals honestly, and provide accurate
                unit-based pricing before any treatment begins. Consultation: ₹600.
              </p>
            ...
            <div style={{ marginTop: "3rem", paddingTop: "2rem", borderTop: "1px solid rgba(199,141,107,0.2)" }}>
              ...
              <div style={{ display: "flex", flexWrap: "wrap", gap: "0.5rem" }}>
                {["botox cost Kanpur", "botox price Kanpur 2026", "anti-aging Kanpur", "dermatologist Kanpur botox", "botox treatment Kanpur"].map((tag) => (
                  <span
                    key={tag}
                    style={{
