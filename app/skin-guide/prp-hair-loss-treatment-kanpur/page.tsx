        ...
        <article className="pt-40 pb-24">
          ...
          <header className="max-w-4xl mx-auto px-6 lg:px-8 mb-14">
            ...
            <h1 style={styles.heading1}>
              ...
              <span style={{ color: "#C4704E" }}>
                A Clinical Guide for Indian Patients
              </span>
            </h1>
          ...
          <div className="max-w-3xl mx-auto px-6 lg:px-8">
            ...
            <p style={styles.para}>
              ...
              re-enter the growth (anagen) phase and strengthen miniaturising
              follicles that are progressively thinning.
            </p>
            <p style={styles.para}>
              ...
              thickness, and scalp coverage compared to placebo.
            </p>
            ...
            <ul style={styles.ul}>
              <li style={styles.li}>
                Men with Hamilton-Norwood Grade I–IV pattern baldness
                (early-to-mid thinning)
              </li>
              <li style={styles.li}>
              ...
              <li style={styles.li}>
                Anyone experiencing generalised hair thinning with identifiable
                follicles on dermatoscopy
              </li>
            </ul>
            <p style={styles.para}>
              Before recommending PRP, we perform a detailed scalp examination
            ...
            <p style={styles.para}>
              ...
              preparation derived from PRP. Whereas standard PRP concentrates
              platelets, GFC takes an additional step to activate those
            ...
            <p style={styles.para}>
              At SKIN@Mantraa, we offer both. For patients with
              moderate-to-advanced thinning or those who have had a partial
              response to PRP, GFC is typically the recommendation. For
              early-stage hair loss or younger patients, standard PRP is often
              sufficient. The preparation best suited to you is determined at
              consultation.
            </p>
            ...
            <p style={styles.para}>
              The standard PRP protocol is 4 sessions spaced 3 to 4 weeks apart.
              After the initial course:
            </p>
            <ul style={styles.ul}>
              <li style={styles.li}>
                Sessions 1–2: Reduced shedding is usually the first change
                patients notice. Hair loss slows.
              </li>
              <li style={styles.li}>
                Sessions 3–4: New fine hairs begin appearing at the hairline and
                crown. Existing hairs become thicker.
              </li>
              <li style={styles.li}>
                Months 3–6 post-course: Visible improvement in density as the
            ...
            <p style={styles.para}>
              ...
              panel before PRP is started, because PRP's effects will be
              partially offset if a nutritional deficiency is simultaneously
            ...
            <ul style={styles.ul}>
              <li style={styles.li}>
                Restore hair in areas of complete baldness (no follicles
                present)
              </li>
              <li style={styles.li}>
              ...
              <li style={styles.li}>
                Replace a hair transplant for patients who are candidates for
                surgical restoration
              </li>
              <li style={styles.li}>
                Produce dramatic results in a single session
              </li>
            </ul>
            <p style={styles.para}>
