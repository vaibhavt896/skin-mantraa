...
function BeforeAfterPlaceholder({ treatment, category }: { treatment: string; category: string }) {
  return (
    <div
...
function TransformationCard({ item, index }: { item: Transformation; index: number }) {
  return (
    ...
    >
      {/* Before/After visual */}
      <BeforeAfterPlaceholder treatment={item.treatment} category={item.category} />
