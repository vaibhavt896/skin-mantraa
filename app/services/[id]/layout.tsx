...
const SERVICE_META: Record<string, { title: string; description: string }> = {
  "laser-treatments": {
    title:
      "Advanced Laser Treatments in Kanpur - Hair Removal, Pigmentation, Tattoo | SKIN@Mantraa",
    description:
  ...
  "anti-aging": {
    title:
      "Anti-Aging & Rejuvenation in Kanpur - Botox, Fillers, HIFU, Thread Lift | SKIN@Mantraa",
    description:
  ...
  "acne-scars": {
    title:
      "Acne & Scar Treatment in Kanpur - Dermapen 4, Chemical Peels, TCA CROSS | SKIN@Mantraa",
    description:
  ...
  "hair-restoration": {
    title:
      "Hair Restoration in Kanpur - PRP, GFC, Mesotherapy for Hair Loss | SKIN@Mantraa",
    description:
  ...
  "skin-conditions": {
    title:
      "Skin Disease Treatment in Kanpur - Vitiligo, Psoriasis, Eczema | SKIN@Mantraa",
    description:
  ...
  cosmetic: {
    title:
      "Cosmetic Skin Treatments in Kanpur - Pigmentation, Tattoo Removal, Brightening | SKIN@Mantraa",
    description:
