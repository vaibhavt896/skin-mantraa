    ...
    process: [
      {
        step: "01",
        title: "Assessment",
        text: "Skin type analysis and patch test to determine optimal laser settings.",
      },
      {
        step: "02",
        title: "Preparation",
        text: "Cleaning the target area and applying cooling gel or numbing cream if required.",
      },
      {
        step: "03",
        title: "Treatment",
        text: "Precise application of laser energy by Dr. Bhura or trained technicians under her supervision.",
      },
      {
        step: "04",
        title: "Aftercare",
        text: "Application of soothing balms and detailed sun-protection guidelines.",
      },
    ],
    expectedResults:
    ...
    faqs: [
      {
        ...
        a: "Most patients describe it as a mild snapping or warming sensation. The laser handpiece has built-in cooling that reduces surface discomfort. Topical anaesthetic is available for facial treatments. There is no downtime - patients return to normal activities immediately.",
      },
      {
        q: "How many sessions does laser hair removal take?",
        a: "Most patients need 6 to 8 sessions spaced 4 to 6 weeks apart for significant and lasting hair reduction. This follows the natural hair growth cycle - only follicles in the active (anagen) phase are destroyed per session. After completing the course, 80 to 90% permanent hair reduction is typical.",
      },
      {
        q: "Which laser is safe for Indian skin?",
        a: "For Fitzpatrick Type III–V Indian skin, we use Nd:YAG 1064nm and diode 810nm lasers - both have lower melanin absorption and are significantly safer for darker skin tones than alexandrite 755nm. Settings are calibrated per patient at every session.",
      },
      {
        q: "Can laser treat pigmentation and dark spots?",
        a: "Yes. Q-switched Nd:YAG laser targets melanin in dark spots, melasma patches, and post-acne pigmentation. We also use laser for tattoo removal and skin resurfacing to improve texture and clarity.",
      },
      {
        q: "What should I do before a laser session?",
        a: "Shave (not wax) the treatment area 24 hours before. Avoid sun exposure for 2 weeks prior. Arrive with clean, product-free skin. After each session, apply SPF 50+ sunscreen and avoid direct sun for 2 weeks.",
      },
      {
        q: "How much does laser treatment cost in Kanpur?",
        a: "Laser treatment cost at SKIN@Mantraa is priced per session by treatment area. Multi-session packages are available. Book a consultation (₹600) for a personalised assessment and pricing based on your specific concern and areas.",
      },
    ],
  },
  "anti-aging": {
    ...
    process: [
      {
        step: "01",
        title: "Consultation",
        text: "Mapping facial anatomy and discussing aesthetic goals.",
      },
      {
        step: "02",
        title: "Customization",
        text: "Selecting the precise grade of filler or Botox units needed.",
      },
      {
        step: "03",
        title: "Procedure",
        text: "Strategic injections to achieve symmetry and lift.",
      },
      {
        step: "04",
        title: "Review",
        text: "A follow-up assessment after 2 weeks to ensure perfect results.",
      },
    ],
    expectedResults:
      "Botox results become visible within 7–14 days and last 3–6 months; with regular treatment, longevity often increases over time as treated muscles become less hyperactive. Dermal filler results are immediate and last 9–18 months depending on the area and product used. Thread lift provides visible lifting within 2–4 weeks with results lasting 12–18 months. HIFU results develop gradually over 3–6 months as new collagen forms, with tightening lasting up to 18 months.",
    faqs: [
      {
        q: "Will I look 'frozen' after Botox?",
        a: "No. Dr. Bhura's approach is precise micro-dosing to soften expression lines while preserving natural facial movement. Over-treatment is the cause of the 'frozen' look - not Botox itself. The goal is that you look rested and refreshed, not treated.",
      },
      {
        q: "How long does Botox last?",
        a: "Botox typically lasts 3 to 6 months. With regular treatment, many patients find results last progressively longer as treated muscles become less hyperactive over time.",
      },
      {
        q: "How long do dermal fillers last?",
        a: "Hyaluronic acid fillers last 9 to 18 months depending on the product, treatment area, and individual metabolism. Fillers in high-movement areas (lips) break down faster than those in lower-movement areas (cheeks, under-eye).",
      },
      {
        q: "What is the difference between Botox and fillers?",
        a: "Botox relaxes muscles that cause expression lines (forehead, frown lines, crow's feet). Fillers restore volume lost with age - in the cheeks, under-eye area, nasolabial folds, lips, and jawline. They treat different problems and are often used together for comprehensive rejuvenation.",
      },
      {
        q: "Is HIFU better than Botox for anti-aging?",
        a: "They address different concerns. HIFU treats structural skin laxity - it tightens the SMAS layer, the same tissue a surgeon tightens during a facelift. Botox treats dynamic wrinkles caused by muscle movement. Thread lift addresses moderate skin sagging. Many patients benefit from a combination approach.",
      },
      {
        q: "How much do anti-aging treatments cost in Kanpur?",
        a: "Botox is priced per unit used; fillers per syringe (1ml). Costs vary by area and degree of treatment needed. HIFU pricing depends on treatment area (full face, lower face, décolletage). Book a consultation (₹600) for a complete assessment and personalised pricing.",
      },
    ],
  },
  "acne-scars": {
    ...
    process: [
      {
        step: "01",
        title: "Diagnosis",
        text: "Identifying the root cause-hormonal, bacterial, or lifestyle.",
      },
      {
        step: "02",
        title: "Exfoliation",
        text: "Clearing clogged pores through medical-grade extractions or peels.",
      },
      {
        step: "03",
        title: "Repair",
        text: "Treating deep scars with microneedling or TCA Cross techniques.",
      },
      {
        step: "04",
        title: "Maintenance",
        text: "A personalized home-care regimen to prevent future breakouts.",
      },
    ],
    expectedResults:
    ...
    faqs: [
      {
        q: "Can old acne scars be removed?",
        a: "Yes. Even years-old atrophic (depressed) acne scars can be significantly improved with Dermapen 4 microneedling, TCA cross, or fractional laser. Most patients achieve 40 to 70% improvement after a full course. Deep ice-pick scars may need TCA cross before microneedling for best results.",
      },
      {
        q: "Are chemical peels safe for Indian skin?",
        a: "Yes - when properly prescribed. We use pH-controlled glycolic, salicylic, and mandelic acid peels calibrated for Indian skin (Fitzpatrick Type III–V). A 4-week priming phase with topical depigmenting agents precedes all peels to reduce the risk of post-inflammatory hyperpigmentation.",
      },
      {
        q: "How many Dermapen 4 sessions are needed for acne scars?",
        a: "Most patients require 4 to 6 sessions spaced 4 weeks apart. Improvement continues for 3 to 6 months after the final session as collagen remodelling completes. Rolling and boxcar scars typically show 40 to 60% improvement after a full course.",
      },
      {
        q: "What is the difference between acne marks and acne scars?",
        a: "Acne marks (post-inflammatory hyperpigmentation or PIH) are flat, discoloured areas left after a pimple heals. They fade with topicals and peels over months. Acne scars are structural skin changes - depressed (ice pick, boxcar, rolling) or raised (hypertrophic) - that require procedural treatment and do not fade on their own.",
      },
      {
        q: "Is there downtime after acne scar treatment?",
        a: "Dermapen 4 causes 24 to 48 hours of redness. Chemical peels cause mild flaking for 3 to 5 days. Most patients return to work the next day. We provide specific aftercare instructions including SPF 50+ sunscreen use, which is mandatory for all peeling procedures.",
      },
      {
        q: "How much does acne scar treatment cost in Kanpur?",
        a: "Treatment costs at SKIN@Mantraa vary by procedure type and number of sessions. Chemical peels and Dermapen 4 are priced per session; package rates are available. Book a consultation (₹600) for a scar classification assessment and personalised treatment plan with pricing.",
      },
    ],
  },
  "hair-restoration": {
    ...
    process: [
      {
        step: "01",
        title: "Blood Draw",
        text: "Extracting a small amount of your own blood-similar to a lab test.",
      },
      {
        step: "02",
        title: "Centrifugation",
        text: "Spinning the blood to concentrate growth factors and platelets.",
      },
      {
        step: "03",
        title: "Activation",
        text: "Preparing the concentrate for maximum regenerative potential.",
      },
      {
        step: "04",
        title: "Injection",
        text: "Micro-injections into the scalp areas with thinning hair.",
      },
    ],
    expectedResults:
      "Most patients notice a significant reduction in hair fall within 4–6 weeks of starting PRP treatment. Visible density improvement and new hair growth typically become apparent after the second or third session (6–8 weeks in). Maximum results are seen 4–6 months after completing the initial course of 4 sessions. Maintenance sessions every 4–6 months sustain results over the long term. GFC patients typically see faster and more pronounced response than standard PRP.",
    faqs: [
      {
        q: "Does PRP hair treatment hurt?",
        a: "The injections cause mild discomfort. We apply topical anaesthetic cream for 30 to 45 minutes before the procedure, making it well-tolerated by most patients. There is no downtime - patients return to work the same day. Mild scalp tenderness and redness for 24 to 48 hours are normal.",
      },
      {
        q: "How many PRP sessions are needed for hair loss?",
        a: "The standard protocol is 4 sessions spaced 3 to 4 weeks apart, followed by maintenance sessions every 4 to 6 months. Most patients notice reduced shedding after sessions 2 to 3, and visible density improvement by the 3 to 4 month mark after completing the initial course.",
      },
      {
        q: "What is the difference between PRP and GFC for hair?",
        a: "PRP (Platelet Rich Plasma) concentrates platelets from your own blood. GFC (Growth Factor Concentrate) further extracts growth factors at a higher concentration, producing more PDGF, VEGF, and EGF than standard PRP. For moderate-to-advanced thinning or partial response to PRP, GFC is often recommended.",
      },
      {
        q: "Is PRP effective for female pattern hair loss?",
        a: "Yes. Female pattern hair loss (diffuse thinning over the crown and mid-scalp) responds well to PRP and GFC. In women, we often combine PRP with topical minoxidil or nutritional supplementation depending on the underlying cause - hormonal, nutritional deficiency, or post-partum.",
      },
      {
        q: "Do I need a blood test before PRP hair treatment?",
        a: "Yes. All hair loss patients at SKIN@Mantraa receive a baseline blood panel (ferritin, Vitamin D3, B12, thyroid function, and hormonal markers) before PRP begins. Nutritional deficiencies - especially ferritin and Vitamin D3 - are very common in Indian patients and will offset PRP results if not corrected.",
      },
      {
        q: "How much does PRP hair treatment cost in Kanpur?",
        a: "PRP and GFC hair treatment cost at SKIN@Mantraa depends on the treatment area and preparation type. Book a consultation (₹600) for a hair loss assessment, blood work recommendations, and complete pricing for your personalised protocol.",
      },
    ],
  },
  "skin-conditions": {
    ...
    process: [
      {
        step: "01",
        title: "History",
        text: "Detailed review of flare-ups, triggers, and past treatments.",
      },
      {
        step: "02",
        title: "Examination",
        text: "Close clinical inspection, sometimes including dermoscopy.",
      },
      {
        step: "03",
        title: "Plan",
        text: "Prescribing a mix of topical, oral, or light-based therapies.",
      },
      {
        step: "04",
        title: "Follow-up",
        text: "Regular monitoring to manage chronic conditions safely.",
      },
    ],
    expectedResults:
    ...
    faqs: [
      {
        ...
        a: "Vitiligo cannot be permanently cured, but it can be effectively stabilised and repigmented in most cases. NB-UVB phototherapy combined with topical steroids or tacrolimus produces repigmentation in a significant proportion of patients. The earlier treatment begins, the better the response.",
      },
      {
        q: "How is psoriasis managed at SKIN@Mantraa?",
      ...
      {
        q: "What treatments are available for vitiligo phototherapy in Kanpur?",
      ...
      {
        q: "Can eczema be treated permanently?",
    ...
    process: [
      {
        step: "01",
        title: "Analysis",
        text: "Determining the depth and type of pigmentation or ink.",
      },
      {
        step: "02",
        title: "Protection",
        text: "Ensuring skin barrier health before aggressive treatment.",
      },
      {
        step: "03",
        title: "Procedure",
        text: "Light-based or chemical enhancement of skin tone.",
      },
      {
        step: "04",
        title: "Regimen",
        text: "Maintenance using medical-grade serums and sunscreen.",
      },
    ],
    expectedResults:
      "Carbon laser facial delivers visible brightening and pore-refinement immediately after each session, with optimal results after 3–4 monthly treatments. Tattoo removal produces noticeable fading after each session - most tattoos are cleared in 6–10 sessions spaced 6–8 weeks apart. Pigmentation and dark spot treatments produce visible lightening after 2–4 sessions. Skin resurfacing results - improved texture, reduced fine lines - are visible within 4–6 weeks and continue to improve over 3 months.",
    faqs: [
      {
        q: "How many sessions does tattoo removal take?",
        a: "Tattoo removal requires 5 to 10 sessions depending on the ink colours, depth, age of the tattoo, and skin type. Dark inks (black, dark blue) respond fastest to Q-switched Nd:YAG laser. Coloured inks (red, green, yellow) may require more sessions or specific wavelengths. Sessions are spaced 6 to 8 weeks apart.",
      },
      {
        q: "Can melasma be permanently cleared?",
        a: "Melasma can be significantly lightened and kept clear with the right maintenance protocol, but it is not a one-time cure. After treatment (chemical peels or laser), daily SPF 50+ PA+++ sunscreen and maintenance topical agents are required to prevent recurrence. Without ongoing sun protection, melasma will return.",
      },
      {
        q: "What is a carbon laser facial and what does it do?",
        a: "A carbon laser facial (sometimes called a Hollywood facial or black doll facial) involves applying a carbon lotion to the skin, which is then vaporised by Q-switched Nd:YAG laser. It removes dead skin cells, unclogs pores, reduces oil production, and leaves skin brighter and smoother. It is suitable for all skin tones including Indian skin.",
      },
      {
        q: "Is skin resurfacing safe for dark Indian skin?",
        a: "Yes - when the correct technique is used. We do not use ablative CO2 laser resurfacing on Indian skin due to the high risk of post-inflammatory hyperpigmentation. Instead, we use Nd:YAG fractional laser, Dermapen 4 microneedling, and chemical peels - all of which produce skin resurfacing effects with a much lower pigmentation risk for Fitzpatrick Type III–V skin.",
      },
      {
        q: "How is pigmentation treatment different from melasma treatment?",
        a: "Pigmentation treatment is a broader term that includes melasma, post-inflammatory hyperpigmentation (PIH from acne or injury), sun spots, and freckles. Each has a different cause and responds differently to treatment. Melasma requires a phased approach with priming. PIH responds well to chemical peels and targeted topicals. Sun spots often respond quickly to Q-switched laser.",
      },
      {
        q: "How much do cosmetic treatments cost at SKIN@Mantraa?",
        a: "Tattoo removal is priced per session by tattoo size. Carbon laser facial, pigmentation treatment, and skin resurfacing are priced per session with package rates available. Book a consultation (₹600) for an assessment of your specific concern and personalised pricing.",
      },
    ],
  },
};
      ...
      <main style={{ background: "#FDF6EC" }}>
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
            ...
            >
              <motion.div variants={fadeInUp} className="mb-6">
                <Link
                  href="/services"
                  className="text-brand-rosegold text-sm uppercase tracking-widest font-medium hover:opacity-70 transition-opacity"
                >
                  ← Back to Services
                </Link>
              </motion.div>
              <motion.h1
                variants={fadeInUp}
                className="text-5xl md:text-7xl font-display font-semibold italic text-brand-espresso mb-6"
              >
                {detail.title}
              </motion.h1>
              <motion.p
                variants={fadeInUp}
                className="text-xl text-brand-terracotta font-accent tracking-wide mb-8"
              >
                {detail.subtitle}
              </motion.p>
              <motion.p
                variants={fadeInUp}
                className="text-lg text-brand-walnut max-w-3xl leading-relaxed"
              >
                {detail.description}
              </motion.p>
            </motion.div>
        ...
        <section className="py-24 bg-white">
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div>
                <h2 className="text-4xl font-display font-semibold italic text-brand-espresso mb-8">
                ...
                <ul className="space-y-6">
                  {detail.benefits.map((benefit: string, i: number) => (
                    ...
                    >
                      ...
                      <span className="text-brand-walnut text-lg">
                        {benefit}
                      </span>
                    </motion.li>
                  ))}
          ...
          <div className="max-w-4xl mx-auto px-6 lg:px-8">
            ...
            <div className="space-y-5">
              {detail.candidateFor.map((paragraph: string, i: number) => (
                <p
                  key={i}
                  className="text-brand-walnut text-lg leading-relaxed"
                >
                  {paragraph}
                </p>
              ))}
        ...
        <section className="py-24 bg-white">
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-display font-semibold italic text-brand-espresso mb-4">
                The Experience
              </h2>
              <p className="text-brand-walnut max-w-2xl mx-auto">
                From the moment you step in, Dr. Bhura ensures your journey is
                clinical, comfortable, and clear.
              </p>
            </div>
            <div className="grid md:grid-cols-4 gap-8">
              {detail.process.map((p, i) => (
                <div
                  key={i}
                  className="bg-white p-8 rounded-2xl shadow-sm border border-brand-champagne/30"
                >
                  <span className="text-4xl font-display font-bold text-brand-rosegold/20 mb-4 block">
                    {p.step}
                  </span>
                  <h3 className="text-xl font-display font-semibold text-brand-espresso mb-3">
                    {p.title}
                  </h3>
                  <p className="text-brand-walnut text-sm leading-relaxed">
                    {p.text}
                  </p>
                </div>
              ))}
        ...
        <section className="py-24 bg-white">
          <div className="max-w-3xl mx-auto px-6 lg:px-8">
            <h2 className="text-4xl font-display font-semibold italic text-brand-espresso mb-12 text-center">
              Frequently Asked Questions
            </h2>
            <div className="space-y-8">
              {detail.faqs.map((faq, i) => (
                <div key={i} className="border-b border-brand-champagne pb-8">
                  <h3 className="text-xl font-display font-semibold text-brand-espresso mb-4">
                    {faq.q}
                  </h3>
        ...
        <section className="py-24 bg-brand-espresso text-brand-cream text-center relative overflow-hidden">
          <div className="max-w-3xl mx-auto px-6 lg:px-8 relative z-10">
            <h2 className="text-4xl md:text-5xl font-display font-semibold italic mb-8">
              Ready to see the results for yourself?
            </h2>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href={`/contact?concern=${id}`} className="btn-primary">
                Book Consultation
              </Link>
              <Link
                href="/results"
                className="btn-ghost !text-brand-cream !border-brand-cream/30 hover:!bg-brand-cream/10"
              >
                View Results
              </Link>
            </div>
