...
const SOCIAL_LINKS = [
  {
    label: "Instagram",
    href: "https://www.instagram.com/skinmantraa_official/",
    icon: (
  ...
  {
    label: "Facebook",
    href: "https://www.facebook.com/skinmantraaofficial12/?ref=NONE_xav_ig_profile_page_web#",
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
  ...
  {
    label: "Practo",
    href: "https://www.practo.com/kanpur/doctor/mamta-bhura-dermatologist?practice_id=1103661&specialization=Dermatologist&referrer=doctor_listing&page_uid=e4732e39-e6cb-4ccf-b26e-6f5ef76577ea",
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
    ...
    <footer style={{ background: "#2C1810", color: "#F5E6D3" }}>
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
            ...
            <div className="flex items-center gap-3 mt-6">
              {SOCIAL_LINKS.map((s) => (
                <a
                  ...
                  onMouseEnter={(e) => {
                    (e.currentTarget as HTMLElement).style.background = "rgba(196,112,78,0.2)";
                    (e.currentTarget as HTMLElement).style.color = "#F5E6D3";
                    (e.currentTarget as HTMLElement).style.borderColor = "rgba(196,112,78,0.4)";
                  }}
                  onMouseLeave={(e) => {
                    (e.currentTarget as HTMLElement).style.background = "rgba(199,141,107,0.1)";
                    (e.currentTarget as HTMLElement).style.color = "#C78D6B";
                    (e.currentTarget as HTMLElement).style.borderColor = "rgba(199,141,107,0.2)";
                  }}
                >
                  {s.icon}
                </a>
          ...
          {/* Column 4: Contact + Hours + Newsletter */}
          <div>
            <h4
              className="mb-6"
              style={{
            ...
            {/* WhatsApp */}
            <a
              href={`https://wa.me/${BRAND.clinic.whatsapp}?text=Hello%2C%20I%20would%20like%20to%20schedule%20a%20consultation%20at%20SKIN%40Mantraa.`}
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-3 mb-3 transition-colors duration-200"
              style={{ textDecoration: "none" }}
