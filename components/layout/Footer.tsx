...
const SOCIAL_LINKS = [
  {
    label: "Instagram",
    href: "https://instagram.com/skinmantraa",
    icon: (
  ...
  {
    label: "Practo",
    href: "https://www.practo.com/kanpur/dermatologist",
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <div>
              ...
              {subscribed ? (
                <p style={{ fontFamily: "var(--font-body)", fontSize: "0.8125rem", color: "#D4A76A" }}>
                ...
                <form onSubmit={handleSubscribe} className="flex gap-2">
                  ...
                  <button
                    type="submit"
                    className="px-4 py-2 rounded-lg text-sm font-medium text-white flex-shrink-0 transition-all duration-200"
                    style={{
                      fontFamily: "var(--font-accent)",
