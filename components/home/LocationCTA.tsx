...
function PhoneIcon() {
  return (
    ...
    >
      <path
        d="M3 3.5C3 3.5 4 2 5.5 2C7 2 8 4 8 4L6.5 6C6.5 6 7 7.5 9 9.5C11 11.5 12.5 12 12.5 12L14.5 10.5C14.5 10.5 16 11.5 16 13C16 14.5 14.5 15.5 14.5 15.5C14.5 15.5 12 17 8 13C4 9 3 6 3 6C3 6 2 5 3 3.5Z"
        stroke="#C78D6B"
        strokeWidth="1.4"
        strokeLinejoin="round"
        fill="rgba(199,141,107,0.1)"
  ...
  return (
    ...
    >
      <circle
        ...
        stroke="#C78D6B"
        strokeWidth="1.4"
        fill="rgba(199,141,107,0.08)"
      />
      <path
        d="M6 7.2C6 7.2 6.2 6 7.2 6C8.2 6 8.8 7.5 8.8 7.5L7.8 8.8C7.8 8.8 8.2 9.8 9.2 10.5C10.2 11.2 11.2 11.2 11.2 11.2L12.5 10.2C12.5 10.2 14 10.8 14 11.8C14 12.8 12.8 13 12.8 13C12.8 13 8.5 13.5 5.5 9.5C5.5 9.5 5 8.4 6 7.2Z"
        stroke="#C78D6B"
        strokeWidth="1.2"
        strokeLinejoin="round"
        fill="none"
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <path
            d="M18 2C10.268 2 4 8.268 4 16C4 26 18 44 18 44C18 44 32 26 32 16C32 8.268 25.732 2 18 2Z"
            fill="url(#pinGrad)"
        ...
        {HOURS.map((row, idx) => (
          <div
            ...
            style={{
              ...
              borderBottom:
                idx < HOURS.length - 1
                  ? "1px solid rgba(199,141,107,0.1)"
                  : "none",
              background:
                idx % 2 === 0 ? "rgba(199,141,107,0.04)" : "transparent",
            }}
          >
            <span
              style={{
...
export default function LocationCTA() {
  ...
  const whatsappMsg = encodeURIComponent(
    "Hi Dr. Mamta Bhura, I'd like to book an appointment at SKIN@Mantraa.",
  );
    ...
    >
      ...
      <div
        ...
        style={{
          ...
          height: "320px",
          borderRadius: "50%",
          border: "1.5px dashed rgba(199,141,107,0.2)",
          pointerEvents: "none",
        }}
      />
      <div
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-stretch">
          ...
          <motion.div
            ...
            style={{
              ...
              overflow: "hidden",
              height: "440px",
              boxShadow: "0 20px 60px rgba(60,43,31,0.15)",
            }}
          >
            <Image
            ...
            <div
              ...
              style={{
                ...
                inset: 0,
                background:
                  "linear-gradient(to bottom, rgba(30,15,9,0.15) 0%, transparent 40%, rgba(30,15,9,0.55) 100%)",
                pointerEvents: "none",
              }}
            />
          ...
          <motion.div
            ...
            style={{
              ...
              boxShadow:
                "0 20px 60px rgba(60,43,31,0.1), inset 0 1px 0 rgba(255,255,255,0.8)",
              border: "1px solid rgba(199,141,107,0.15)",
              display: "flex",
          ...
          >
            ...
            <div
              style={{
                height: "1px",
                background:
                  "linear-gradient(90deg, #C78D6B, rgba(212,167,106,0.2), transparent)",
              }}
              aria-hidden="true"
            />
            ...
            >
              ...
              <ContactRow icon={<PhoneIcon />}>
                <a
                  ...
                  onMouseEnter={(e) =>
                    (e.currentTarget.style.color = "#C78D6B")
                  }
                  onMouseLeave={(e) =>
            ...
            <div
              style={{ height: "1px", background: "rgba(199,141,107,0.15)" }}
              aria-hidden="true"
            />
      ...
      >
        SKIN@Mantraa is Kanpur&apos;s leading dermatology and cosmetology
        clinic, serving patients from Swaroop Nagar, Kakadeo, Civil Lines,
        Kidwai Nagar, Govind Nagar, Rawatpur, and across Uttar Pradesh.
