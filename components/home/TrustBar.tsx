    ...
    >
      ...
      <motion.div
        ...
        style={{
          ...
          inset: 0,
          background:
            "radial-gradient(ellipse at center, rgba(212,167,106,0.11) 0%, transparent 70%)",
          pointerEvents: "none",
        }}
      />
      ...
      <motion.div
        ...
        style={{
          ...
          width: "36px",
          background:
            "linear-gradient(90deg, transparent, #D4A76A, transparent)",
...
export default function TrustBar() {
  ...
  return (
    <section
      ...
      style={{
        background:
          "linear-gradient(135deg, #1a0c07 0%, #2C1810 50%, #1a0c07 100%)",
    ...
    >
      ...
      <motion.div
        ...
        style={{
          ...
          height: "2px",
          background:
            "linear-gradient(90deg, transparent 0%, #D4A76A 25%, #C4704E 50%, #D4A76A 75%, transparent 100%)",
      ...
      <motion.div
        ...
        style={{
          ...
          height: "2px",
          background:
            "linear-gradient(90deg, transparent 0%, #C4704E 25%, #D4A76A 50%, #C4704E 75%, transparent 100%)",
          backgroundSize: "200% 100%",
        }}
      />
      ...
      <div
        ...
        style={{
          ...
          height: "500px",
          background:
            "radial-gradient(ellipse, rgba(212,167,106,0.07) 0%, transparent 65%)",
          pointerEvents: "none",
        }}
      />
        ...
        >
          ...
          <motion.div
            ...
            style={{
              ...
              background:
                "linear-gradient(135deg, rgba(212,167,106,0.18) 0%, rgba(196,112,78,0.12) 100%)",
          ...
          >
            <span
              style={{
                width: "18px",
                height: "18px",
                borderRadius: "50%", // Smaller circle for mobile wrap
          ...
          <div className="flex flex-wrap items-center justify-center gap-2">
            {BRAND.doctor.memberships.map((badge) => (
              <motion.span
                ...
                whileHover={{
                  scale: 1.07,
                  borderColor: "rgba(212,167,106,0.6)",
