...
import { slideInFromLeft, slideInFromRight, staggerContainer, fadeInUp } from "@/lib/animations";
    ...
    >
      ...
      <motion.div aria-hidden="true"
        ...
        style={{
          ...
          background: "radial-gradient(circle, rgba(196,112,78,0.22) 0%, transparent 65%)",
      ...
      <motion.div aria-hidden="true"
        ...
        style={{
          ...
          background: "radial-gradient(circle, rgba(212,167,106,0.2) 0%, transparent 65%)",
      ...
      >
        ...
        <motion.div
          ...
          style={{
            padding: "2px",
            borderRadius: "24px",
            background: "linear-gradient(145deg, rgba(212,167,106,0.85) 0%, rgba(196,112,78,0.5) 45%, rgba(212,167,106,0.75) 100%)",
            boxShadow: "0 48px 120px rgba(60,43,31,0.22), 0 0 80px rgba(199,141,107,0.14)",
          }}
        >
          {/* Photo card */}
          <div style={{
            ...
            <motion.div aria-hidden="true"
              ...
              style={{ position: "absolute", top: "16px", left: "16px", width: "22px", height: "22px", borderTop: "2px solid #D4A76A", borderLeft: "2px solid #D4A76A", zIndex: 4 }}
            />
            {/* Top-right */}
            <motion.div aria-hidden="true"
              animate={{ opacity: [0.45, 1, 0.45] }}
              transition={{ duration: 2.8, repeat: Infinity, delay: 0.5 }}
              style={{ position: "absolute", top: "16px", right: "16px", width: "22px", height: "22px", borderTop: "2px solid #D4A76A", borderRight: "2px solid #D4A76A", zIndex: 4 }}
            />
            {/* Bottom-left */}
            <motion.div aria-hidden="true"
              animate={{ opacity: [0.45, 1, 0.45] }}
              transition={{ duration: 2.8, repeat: Infinity, delay: 1 }}
              style={{ position: "absolute", bottom: "16px", left: "16px", width: "22px", height: "22px", borderBottom: "2px solid #D4A76A", borderLeft: "2px solid #D4A76A", zIndex: 4 }}
            />
            {/* Bottom-right */}
            <motion.div aria-hidden="true"
              animate={{ opacity: [0.45, 1, 0.45] }}
              transition={{ duration: 2.8, repeat: Infinity, delay: 1.5 }}
              style={{ position: "absolute", bottom: "16px", right: "16px", width: "22px", height: "22px", borderBottom: "2px solid #D4A76A", borderRight: "2px solid #D4A76A", zIndex: 4 }}
            />
            ...
            <div style={{
              ...
              background: "linear-gradient(to top, rgba(30,15,8,0.88) 0%, rgba(30,15,8,0.5) 45%, transparent 100%)",
              zIndex: 2,
            }}>
              <div style={{ display: "flex", alignItems: "flex-end", justifyContent: "space-between" }}>
                <div>
                  <div style={{
                    ...
                    fontWeight: 600, color: "#fff", letterSpacing: "-0.01em", lineHeight: 1.2,
                  }}>{BRAND.doctor.name}</div>
                  <div style={{
                    fontFamily: "var(--font-accent)", fontSize: "0.62rem", fontWeight: 500,
                    color: "#D4A76A", letterSpacing: "0.14em",
                    textTransform: "uppercase" as const, marginTop: "0.25rem",
                  }}>{BRAND.doctor.specialization}</div>
                </div>
                {/* Verified tick */}
                <div style={{
        ...
        <motion.div
          ...
          style={{
            ...
            padding: "0.55rem 1rem", borderRadius: "14px",
            boxShadow: "0 8px 28px rgba(60,43,31,0.14), 0 0 0 1px rgba(199,141,107,0.18)",
        ...
        <motion.div
          ...
          style={{
            position: "absolute", top: "38%", left: "-1.75rem",
            background: "rgba(255,255,255,0.92)", backdropFilter: "blur(14px)",
            WebkitBackdropFilter: "blur(14px)",
            padding: "0.5rem 0.85rem 0.5rem 0.6rem", borderRadius: "14px",
            boxShadow: "0 6px 24px rgba(60,43,31,0.12), 0 0 0 1px rgba(199,141,107,0.16)",
            display: "flex", alignItems: "center", gap: "0.5rem",
            zIndex: 5,
          }}
        >
          <div style={{
            ...
            <svg width="15" height="15" viewBox="0 0 20 20" fill="none" aria-hidden="true">
              <path d="M10 2L12.4 7.4H18L13.3 10.7L15.1 16.2L10 12.9L4.9 16.2L6.7 10.7L2 7.4H7.6L10 2Z" fill="rgba(255,255,255,0.95)" />
            </svg>
          </div>
          <div>
            <div style={{ fontFamily: "var(--font-accent)", fontSize: "0.82rem", fontWeight: 700, color: "#3D2B1F", lineHeight: 1 }}>26+</div>
            <div style={{ fontFamily: "var(--font-accent)", fontSize: "0.58rem", color: "#5C4033", letterSpacing: "0.04em", marginTop: "2px" }}>Yrs Experience</div>
          </div>
        </motion.div>
...
export default function DoctorIntro() {
  ...
  return (
    <section
      ref={sectionRef}
      style={{ background: "#FDF6EC", padding: "7rem 1.5rem", overflow: "hidden", position: "relative" }}
    >
      {/* Background texture */}
      <div aria-hidden="true" style={{
        position: "absolute", inset: 0, pointerEvents: "none",
        background: "radial-gradient(ellipse at 20% 50%, rgba(199,141,107,0.05) 0%, transparent 60%), radial-gradient(ellipse at 80% 20%, rgba(212,167,106,0.04) 0%, transparent 50%)",
      }} />

      <div style={{ maxWidth: "1280px", margin: "0 auto", position: "relative", gap: "4rem" }}
      ...
      >
        ...
        <motion.div
          ...
          initial="hidden"
          animate={inView ? "visible" : "hidden"}
          style={{ display: "flex", flexDirection: "column" as const, gap: "1.75rem" }}
        >
          {/* Label */}
          <motion.span variants={fadeInUp} style={{
            display: "inline-flex", alignItems: "center", gap: "0.5rem",
            fontFamily: "var(--font-accent)", fontSize: "0.72rem", fontWeight: 500,
            letterSpacing: "0.14em", textTransform: "uppercase" as const, color: "#C78D6B",
          }}>
            <motion.span
              animate={{ scaleX: [0, 1] }}
              transition={{ duration: 0.6, delay: 0.3 }}
              style={{ display: "block", width: "28px", height: "1.5px", background: "#C78D6B", transformOrigin: "left" }}
              aria-hidden="true"
            />
          ...
          <motion.h2 variants={fadeInUp} style={{
            ...
            lineHeight: 1.08, color: "#3D2B1F", margin: 0,
          }}>
            26 Years of Science,
            <br />
            <span style={{
          ...
          <motion.p variants={fadeInUp} style={{
            ...
            color: "#5C4033", lineHeight: 1.75, margin: 0,
          }}>
            {BRAND.doctor.bio}
          </motion.p>
          ...
          <motion.blockquote
            ...
            style={{
              margin: "0.25rem 0", padding: "1.35rem 1.5rem",
              background: "linear-gradient(135deg, rgba(199,141,107,0.07) 0%, rgba(199,141,107,0.04) 100%)",
              borderLeft: "3px solid #C78D6B", borderRadius: "0 14px 14px 0",
              cursor: "default",
            }}
          >
            <p style={{
              ...
              fontStyle: "italic", color: "#3D2B1F", lineHeight: 1.45, margin: 0,
            }}>
              <span aria-hidden="true" style={{ fontFamily: "Georgia, serif", fontSize: "2.5rem", color: "#C78D6B", lineHeight: 0, verticalAlign: "-0.5rem", marginRight: "0.1em" }}>&ldquo;</span>
              She honestly tells you what can and cannot be treated.
              <span aria-hidden="true" style={{ fontFamily: "Georgia, serif", fontSize: "2.5rem", color: "#C78D6B", lineHeight: 0, verticalAlign: "-0.5rem", marginLeft: "0.1em" }}>&rdquo;</span>
            </p>
            <footer style={{
          ...
          <motion.ul
            ...
            initial="hidden"
            animate={inView ? "visible" : "hidden"}
            style={{ listStyle: "none", margin: 0, padding: 0, display: "flex", flexDirection: "column" as const, gap: "0.6rem" }}
          >
            {QUALIFICATIONS.map((q) => (
              <motion.li
                ...
                style={{
                  ...
                  color: "#5C4033", lineHeight: 1.5, cursor: "default",
                  padding: "0.35rem 0",
                }}
              >
                <span style={{
                  width: "28px", height: "28px", borderRadius: "50%", flexShrink: 0,
                  background: "rgba(199,141,107,0.1)", border: "1px solid rgba(199,141,107,0.25)",
                  display: "flex", alignItems: "center", justifyContent: "center",
                  fontSize: "0.9rem",
                }}>{q.icon}</span>
                {q.text}
