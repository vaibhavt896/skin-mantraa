...
function LaserIcon({ size = 40 }: { size?: number }) {
  return (
    ...
    >
      ...
      />
      <path
        d="M14 13 Q17 10 20 13 Q23 16 26 13 Q29 10 32 13"
        stroke="#C78D6B"
        strokeWidth="1.3"
        strokeLinecap="round"
        fill="none"
      ...
      />
      <path
        d="M14 27 Q17 30 20 27 Q23 24 26 27 Q29 30 32 27"
        stroke="#C78D6B"
        strokeWidth="1.3"
        strokeLinecap="round"
        fill="none"
...
function SparklesIcon({ size = 40 }: { size?: number }) {
  return (
    ...
    >
      <path
        d="M20 6 L21.8 16.2 L32 18 L21.8 19.8 L20 30 L18.2 19.8 L8 18 L18.2 16.2 Z"
        stroke="#C78D6B"
        strokeWidth="1.5"
      ...
      />
      <path
        d="M31 7 L31.8 10.2 L35 11 L31.8 11.8 L31 15 L30.2 11.8 L27 11 L30.2 10.2 Z"
        stroke="#C78D6B"
        strokeWidth="1.2"
        strokeLinejoin="round"
      ...
      />
      <path
        d="M9 25 L9.7 27.3 L12 28 L9.7 28.7 L9 31 L8.3 28.7 L6 28 L8.3 27.3 Z"
        stroke="#C78D6B"
        strokeWidth="1.2"
        strokeLinejoin="round"
        fill="rgba(199,141,107,0.08)"
...
function ShieldIcon({ size = 40 }: { size?: number }) {
  return (
    ...
    >
      <path
        d="M20 5 L34 11 L34 21 C34 29 20 36 20 36 C20 36 6 29 6 21 L6 11 Z"
        stroke="#C78D6B"
        strokeWidth="1.5"
        strokeLinejoin="round"
        fill="rgba(199,141,107,0.08)"
...
function HairIcon({ size = 40 }: { size?: number }) {
  return (
    ...
    >
      <path
        d="M20 35 C20 35 10 26 10 18 C10 11 15 7 20 5 C25 7 30 11 30 18 C30 26 20 35 20 35 Z"
        stroke="#C78D6B"
        strokeWidth="1.5"
        strokeLinejoin="round"
        fill="rgba(199,141,107,0.08)"
...
function StarIcon({ size = 40 }: { size?: number }) {
  return (
    ...
    >
      <path
        d="M20 5 L23.09 14.26 L33 14.26 L25.45 19.94 L28.54 29.2 L20 23.52 L11.46 29.2 L14.55 19.94 L7 14.26 L16.91 14.26 Z"
        stroke="#C78D6B"
        strokeWidth="1.5"
        strokeLinejoin="round"
        fill="rgba(199,141,107,0.1)"
...
function SpotlightCard({
  ...
  const spotlightX = useSpring(
    useTransform(mouseX, (v) => `${v}px`),
    { stiffness: 150, damping: 20 },
  );
  const spotlightY = useSpring(
    useTransform(mouseY, (v) => `${v}px`),
    { stiffness: 150, damping: 20 },
  );
  ...
  return (
    <motion.div
      ...
      whileHover={{
        y: -6,
        boxShadow:
          "0 20px 60px rgba(60,43,31,0.14), 0 0 0 1px rgba(199,141,107,0.3)",
    ...
    >
      ...
      <motion.div
        ...
        style={{
          ...
          borderRadius: "50%",
          background:
            "radial-gradient(circle, rgba(199,141,107,0.18) 0%, transparent 65%)",
      ...
      <motion.div
        ...
        style={{
          ...
          borderRadius: "20px",
          background:
            "linear-gradient(90deg, transparent 0%, rgba(212,167,106,0.4) 50%, transparent 100%)",
          ...
          >
            ...
            <div
              ...
              style={{
                ...
                inset: 0,
                background:
                  "linear-gradient(to bottom, transparent 40%, rgba(253,246,236,0.9) 100%)",
                pointerEvents: "none",
              }}
            />
          </div>
              ...
              .map((treatment, i) => (
                <motion.span
                  ...
                  style={{
                    ...
                    borderRadius: "100px",
                    background: hovered
                      ? "rgba(199,141,107,0.18)"
                      : "rgba(199,141,107,0.1)",
                    color: "#C78D6B",
    ...
    >
      ...
      <div
        ...
        style={{
          ...
          borderRadius: "50%",
          background:
            "radial-gradient(circle, rgba(199,141,107,0.07) 0%, transparent 65%)",
          filter: "blur(60px)",
          pointerEvents: "none",
        }}
      />
      <div
        ...
        style={{
          ...
          borderRadius: "50%",
          background:
            "radial-gradient(circle, rgba(212,167,106,0.06) 0%, transparent 65%)",
          filter: "blur(50px)",
          pointerEvents: "none",
        }}
      />
